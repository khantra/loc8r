//The first line gives the controllers access to the database connection, 
//and the second brings in the Location model 
//so that we can interact with the Locations collection
